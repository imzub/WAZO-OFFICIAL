...
- The v1.1.8 testing installer replacement is 103,207,734 bytes with SHA-256 `3D5C803A6DB914418EA364AD39C8A9F5DE0642FCEC08B3FF54C9BC8E8E133CE8`, sourced from WAZO `Dev/QA` commit `1a9a0d818ea6159f8d28f4c3c228133da44728dc`. The focused financial/SIP/startup/source-contract checks, static/syntax checks, rebuilt NSIS payload, and packaged readiness smoke passed. It is live-verified at website commit `093bc141b4df091afa488833de971b791bdc0b41` through Pages deployment `30938119734`; v1.1.7 remains the stable public release.
