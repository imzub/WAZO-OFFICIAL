...
- Optional testing installer: `v1.1.9` / `docs/site-data/releases/v1.1.9/installer/WAZO-Setup-1.1.9.exe`; status `testing`, stable public release remains `v1.1.7`.
- The v1.1.9 testing installer is 103,209,868 bytes with SHA-256 `CB9981CC163502FDED5FC5496853430D8F6CECAFD9EFEBF1CFE17BD60AEF081F`, sourced from WAZO `codex/v1.1.9-reliability-ui` commit `e109f57` based on `Dev/QA`. Isolated source, startup, trust, package, and UI gates passed; it is live-verified at website commit `01be28f07458fba5bb157235471cc5ff5bb10f5e` through Pages deployment `31051069963` at `2026-08-05T22:05:36Z`. v1.1.8 remains historical testing evidence and v1.1.7 remains stable.
