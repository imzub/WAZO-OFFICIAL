...
- Website `Master` is current at metadata commit `2d39a28`.
- The v2.0.0.0 testing installer is sourced from private WAZO `Dev/QA` commit
  `4284642`, is live-verified, and remains clearly labeled testing. Stable
