...
- Optional testing installer: `v1.1.8` / `docs/site-data/releases/v1.1.8/installer/WAZO-Setup-1.1.8.exe`; status `testing`, stable public release remains `v1.1.7`.
- The v1.1.8 testing installer is 103,205,840 bytes with SHA-256 `BA99682DA105D0FC52EB6C371C43B7C960FC77417C58FC2700F963FDBD014850`, sourced from WAZO commit `14c3a3d640c36c44e38e63de44ebc2eb4ca68b9a`. Its focused source regression passed 143/143, the source/privacy/demo/import subset passed 72/72, Trust Foundation passed on desktop and compact viewports, UI-humanity passed 198/198, static/syntax checks passed, and the corrected NSIS payload/installed startup smoke passed. The exact installer was live-verified at website commit `d1dfb61e07cbd77b97c8b0f5f46f05c3466766c8` through Pages deployment `30927906679` on `2026-08-04T16:16:26Z`. Intermittent DevTools mouse-dispatch transport timeouts mean complete startup/runtime automation and physical human validation remain unclaimed.
- The current Windows x64 installer candidate is 103,200,128 bytes with SHA-256 `489D6775D55E5F3FC7965C357263B5BA452B6BE073DE60CC8B9EC33AF31EF5F5`; it is anchored to WAZO `Dev/QA` source commit `c13bbb973c8866876f527685e52d1875b1de2ad7`. Source tests passed 889/889, focused financial/SIP/source/renderer 77/77, Demo seed/SIP 8/8, UI-humanity 198/198, packaged startup 12/12, and complete isolated runtime 19/19. Pages deployment and cache-busted live verification are pending for this update.
