...
- The v1.1.9 testing installer is 103,209,868 bytes with SHA-256 `CB9981CC163502FDED5FC5496853430D8F6CECAFD9EFEBF1CFE17BD60AEF081F`, sourced from WAZO `codex/v1.1.9-reliability-ui` commit `e109f57` based on `Dev/QA`. Isolated source, startup, trust, package, and UI gates passed; Pages deployment and live hash verification are pending. v1.1.8 remains historical testing evidence and v1.1.7 remains stable.
