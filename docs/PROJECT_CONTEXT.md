...
- The v1.1.9 testing installer is 103,209,860 bytes with SHA-256 `D8097C2BC4CDCF63B80E5A2FCA6F9A79593AFE1ED8A45D371FB81A6A82F0AA01`, sourced from WAZO `codex/v1.1.9-deep-audit` commit `d6533f1` based on `Dev/QA`. Financial/deep-audit 147/147, import/storage/protected 207/207, source/UI 271/271, the 100,000-probe / 460,000-assertion matrix, Trust Foundation, and UI-humanity 198/198 passed. The current startup-flow rerun exceeded its bounded timeout without a report; live byte/hash verification passed at website commit `f976331ac0b0047eea4176c8b8c5047e18528dd5` through Pages deployment `31074581797` at `2026-08-06T05:37:21Z`. v1.1.8 remains historical testing evidence and v1.1.7 remains stable.
