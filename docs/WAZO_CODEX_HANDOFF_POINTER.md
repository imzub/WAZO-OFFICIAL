...
Branch: `Dev/QA` at source commit `3d563d1` for the latest synchronized work; `codex/v1.1.9-deep-audit` is historical lineage only.
...
- An optional v2.0.0 testing installer is listed separately and does not replace or relabel v1.1.7. The replacement candidate is 99,433,175 bytes / SHA-256 `248C263FA712E40AF6835E7902D7C31B7ACFDBB90210ED3980670DF264365B12`, from WAZO `Dev/QA` commit `3d563d1`. It includes the four locally actionable UI/sparse-data fixes; live byte/size verification passed through Pages deployment `31394023056` from website commit `d91d1d3`. v1.1.9 remains historical testing evidence.
