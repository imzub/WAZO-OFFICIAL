...
- Website publication commit `d0269be` deployed through Pages run
  `31898827988`; public HTTP/size/hash verification passed at
  `2026-08-15T17:40:02Z`. The v2.0.0 baseline remains live and byte-preserved.
