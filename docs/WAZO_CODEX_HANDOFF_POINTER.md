...
- An optional v1.1.8 testing installer is listed separately and does not replace or relabel v1.1.7. The current testing installer is 103,207,734 bytes / SHA-256 `3D5C803A6DB914418EA364AD39C8A9F5DE0642FCEC08B3FF54C9BC8E8E133CE8`, from WAZO `Dev/QA` commit `1a9a0d818ea6159f8d28f4c3c228133da44728dc`; its packaged `WAZO.exe`, `resources/app.asar`, and readiness smoke passed. It is live-verified at website commit `093bc141b4df091afa488833de971b791bdc0b41` through Pages deployment `30938119734`.
