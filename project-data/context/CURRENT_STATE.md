...
- The Microsoft Store card uses `ms-windows-store://pdp/?productid=9NKLT8DKJ1QX`; listing availability remains independently unverified. The Store AppX is local-only and was not added to the website.
