...
- Stable baseline website version: `2.0.0` / build `2.0.0.0`
- Latest stable-line bug-fix and enhancement update: `2.0.1` / build `2.0.1.0`; Microsoft Store remains published at the v2.0.0 baseline.
...
The v2.0.1 update installer is 99,453,083 bytes with SHA-256 `F2F04955A46EB2AC0DED9C29D44D0E93D4DA9FFCAE039CE104398171ED123EF8`, anchored to WAZO `Dev/QA` source commit `5b82ddf`. Website commit `018a987` deployed through Pages deployment `31884767262`, and public HTTP/size/hash verification passed at `2026-08-15T12:37:17Z`. The v2.0.0 installer remains the stable baseline and is byte-preserved. The v1.1.6 tour remains historical media. Microsoft Store Submission 5 remains published and available with `WAZO-Store-2.0.0-x64.appx` v2.0.0.0 for X64 Windows.Desktop devices.
