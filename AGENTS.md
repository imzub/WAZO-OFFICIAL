...
- Current stable direct installer is WAZO `v1.1.5`, 102,285,721 bytes, SHA-256 `94EF7F7C3456FE025689A44C228E4D8759F2AD153C12AD22B0ED81CC328D86AB`, from private product source commit `0f03c6084ab023cd14841158bd369461163ac319`. Website artifact-publication commit `94f6cff4868814ee3bc0fd40903e025a72c6331c` deployed successfully, and its public installer bytes/hash were verified at `2026-07-21T12:59:13Z`. Publication was explicitly authorized on 2026-07-21 after the recorded automated release gates passed. Physical human workflow validation is not recorded, and publication must not be described as a human test pass. The earlier 102,284,642-byte `955F0060...A13E` installer is rejected, superseded historical evidence only.
