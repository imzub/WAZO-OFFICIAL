...
- Website checkout is `Master`; the refreshed v2 installer replacement is
  being published on `Master` and will be live-verified from the new Pages
...
- The v2.0.0.0 testing installer replacement is sourced from private WAZO
  ...
  Public byte verification is pending the new Pages deployment from this
  website publication.
