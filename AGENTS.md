...
- Current direct installer is WAZO `v1.1.7`, 103,181,264 bytes, SHA-256 `2DDEADC0D06E171DD7DB95B4D5038DAEB9CABE4BC7849A450EF9EEB2CEB906E1`. Source tests passed 923/923, packaged readiness passed, and Pages deployment `30834371474` live-download verification matched the exact byte count and hash. The Store AppX was generated locally for user testing and is not a website artifact. Physical human workflow validation is not recorded, and publication must not be described as a human test pass. Earlier releases remain historical evidence.
