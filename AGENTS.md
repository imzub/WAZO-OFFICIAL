...
- Current direct installer candidate is WAZO `v1.1.7`, 103,198,673 bytes, SHA-256 `DD9F7E7A3644BBCBC3E9076C3759BBA20B0778F11AD56D2FB31367859C58960E`. Source tests passed 928/928, syntax 98/98, UI-humanity 198/198, portable packaged 18/18 plus native 3/3, and Store-inner packaged 18/18 plus native 3/3. The Store AppX was generated and tested locally for user testing and is not a website artifact. This current candidate awaits Pages deployment/live byte-hash verification; physical human workflow validation is not recorded, and publication must not be described as a human test pass. Earlier releases remain historical evidence.
