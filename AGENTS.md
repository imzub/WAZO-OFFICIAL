...
- The optional testing installer is WAZO `v1.1.8`, 103,207,734 bytes, SHA-256 `3D5C803A6DB914418EA364AD39C8A9F5DE0642FCEC08B3FF54C9BC8E8E133CE8`, from WAZO `Dev/QA` commit `1a9a0d818ea6159f8d28f4c3c228133da44728dc`. It remains labeled Testing; v1.1.7 remains the stable public installer. The focused financial/SIP/startup/source-contract checks, static/syntax checks, rebuilt NSIS payload, and packaged readiness smoke passed. The exact installer is live-verified at website commit `093bc141b4df091afa488833de971b791bdc0b41` through Pages deployment `30938119734` at `2026-08-04T18:22:00Z`. The Store AppX is local-only and is not a website artifact.
