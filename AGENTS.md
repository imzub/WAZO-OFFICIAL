...
- The optional testing installer is WAZO `v1.1.8`, 101,734,632 bytes, SHA-256 `F13CCDA41C68A13C055044F2190C96272CEE5EB446EEAF4B40F875CB4355B5C8`, from WAZO audit-hardening commit `c90835ada83f0c906b2b6b24b16a39334dce2023`. It must remain labeled Testing; v1.1.7 remains the stable public installer. The v1.1.8 source evidence is 143/143 focused regression tests, 72/72 source/privacy/demo/import subset, Trust Foundation PASS, UI-humanity 198/198, and static/syntax checks PASS. The exact installer is live-verified at website commit `4406783f39724fa5ca84e454707f26e4cfe00ba1` through Pages deployment `30923304970`; intermittent DevTools mouse-dispatch transport timeouts mean complete startup/runtime automation and physical human validation remain unclaimed. The Store AppX is local-only and is not a website artifact.
